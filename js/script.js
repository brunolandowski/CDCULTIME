 ...
 $.getJSON('json/lang_fr.json', function (data) {
   ...
   $('#hd_bd_top p:nth-child(1)').html(data.homepage.top_left);
    $('#hd_bd_top p:nth-child(2)').html(data.homepage.top_middle);
...
$("button#fr").click(function(){
    $.getJSON("json/lang_fr.json", function(result_fr){
      $('#hd_bd_top p:nth-child(1)').html(result_fr.homepage.top_left);
    $('#hd_bd_top p:nth-child(2)').html(result_fr.homepage.top_middle);
...
$("button#en").click(function(){
    $.getJSON("json/lang_en.json", function(result_en){
       $('#hd_bd_top p:nth-child(1)').html(result_en.homepage.top_left);
    $('#hd_bd_top p:nth-child(2)').html(result_en.homepage.top_middle);
