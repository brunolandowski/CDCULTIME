...
var Y_AXIS = 1,
    ...
    FPS = 25, 
    NUM_STARS = 242 * 5; // Ideally, this should be related to the real startup number

function setup() {
    inside = color(253, 146, 101);
    c1 = color(253, 80, 90),
    c2 = color(253, 136, 81),
...
fill(inside)
  ...
  for (var i = 20, x = stars.length; i < x; i++) {
    var s = stars[i];
    ellipse(s.x, s.y, 5, 5);
  }
  pop();
